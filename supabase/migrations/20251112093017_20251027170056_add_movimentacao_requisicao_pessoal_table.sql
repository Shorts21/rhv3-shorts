/*
  ...
  1. Nova Tabela: movimentacao_requisicao_pessoal
    ...
    - Campos principais: requisitante, unidade, motivo, cargo, justificativa
    - Campos de Desligamento: nome, tipo de rescisao, aviso, recontratacao
    - Campos de Promocao: unidades, setores, cargos, salarios (atual e proposto)
    - Recursos Necessarios: mesa, cadeira, apoio para pes, EPI
